...
```js
WXAPI.requestX(url, needSubDomain, method, data)
```
...
```js
WEBAPI.loginMobileSmsCode(Object object)
```
...
```js
WEBAPI.authorization(Object object)
```
...
```js
WEBAPI.wxpayQrcode(Object object)
```

用户生成付款二维码，微信扫描该二维码以后，完成付款
