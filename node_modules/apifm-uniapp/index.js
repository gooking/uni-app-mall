...
module.exports = {
  ...
  jdvopQueryCanRefundNumber: data => {
    return request(`/jdvop/${merchantId}/refund/queryCanRefundNumber`, true, 'get', data)
  },
  jdvopQueryRefundType: data => {
    return request(`/jdvop/${merchantId}/refund/queryRefundType`, true, 'get', data)
  },
  jdvopQueryGoodsBackType: data => {
    return request(`/jdvop/${merchantId}/refund/queryGoodsBackType`, true, 'get', data)
  },
  // cps
  ...
  // 京东权益池
	...
	joycityPointsCanApplyAfterSale: data => {
	  ...
	  joycityPointsSearchAfsOrderDetail: data => {
	      return request('/joycityPoints/orders/afsOrderDetail', true, 'get', data)
	    },
}
